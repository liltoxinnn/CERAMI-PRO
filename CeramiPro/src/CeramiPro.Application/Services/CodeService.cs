...
public class CodeService : ICodeService
{
        ...
        EtiquettesRequete requete, CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new RegleMetierException("Choisissez au moins un produit à étiqueter.");
        }
        ...
        string code, CancellationToken cancellationToken = default)
    {
        ...
        if (produit is not null)
        {
            return new ResultatScanDto(
                ...
                $"{Formatage.Quantite(produit.CurrentStock, "pièce")} en stock — " +
                $"{Formatage.Montant(produit.SellingPrice)}",
        ...
        if (matiere is not null)
        {
            return new ResultatScanDto(
                ...
                $"{Formatage.Quantite(matiere.CurrentQuantity)} en stock",
        ...
        if (facture is not null)
        {
            return new ResultatScanDto(
                ...
                Formatage.Montant(facture.TotalAmount),
                $"factures/{facture.Id}");
        }
