...
public static class Traductions
{
    public static IReadOnlyDictionary<string, string> Francais { get; } = new Dictionary<string, string>
    {
        ...
        ["menu.caisse"] = "Caisse",
        ["menu.cuisson.enfourner"] = "Enfourner",
        ["menu.fournisseurs.fiches"] = "Fiches fournisseurs",
        ["menu.fournisseurs.achats"] = "Achats",
        ["menu.fournisseurs.nouvelAchat"] = "Nouvel achat",
        ["menu.administration.categoriesMatieres"] = "Catégories de matières",
        ["menu.rapports"] = "Rapports",
        ["menu.calculateurs"] = "Calculateurs",
        ["menu.produits.etiquettes"] = "Étiquettes",
        ["menu.production.tableau"] = "Tableau de production",
        ["menu.administration"] = "Administration",
        ["menu.administration.utilisateurs"] = "Utilisateurs",
        ["menu.administration.roles"] = "Rôles et droits",
        ["menu.administration.unites"] = "Unités de mesure",
        ["menu.administration.categoriesDepenses"] = "Catégories de dépenses",
        ["menu.administration.sauvegarde"] = "Sauvegarde",
        ["menu.administration.journal"] = "Journal des opérations",
    ...
    public static IReadOnlyDictionary<string, string> Arabe { get; } = new Dictionary<string, string>
    {
        ...
        ["menu.caisse"] = "الصندوق",
        ["menu.cuisson.enfourner"] = "تحميل الفرن",
        ["menu.fournisseurs.fiches"] = "بطاقات الموردين",
        ["menu.fournisseurs.achats"] = "المشتريات",
        ["menu.fournisseurs.nouvelAchat"] = "شراء جديد",
        ["menu.administration.categoriesMatieres"] = "فئات المواد",
        ["menu.rapports"] = "التقارير",
        ["menu.calculateurs"] = "الحاسبات",
        ["menu.produits.etiquettes"] = "الملصقات",
        ["menu.production.tableau"] = "لوحة الإنتاج",
        ["menu.administration"] = "الإدارة",
        ["menu.administration.utilisateurs"] = "المستخدمون",
        ["menu.administration.roles"] = "الأدوار والصلاحيات",
        ["menu.administration.unites"] = "وحدات القياس",
        ["menu.administration.categoriesDepenses"] = "فئات المصاريف",
        ["menu.administration.sauvegarde"] = "النسخ الاحتياطي",
        ["menu.administration.journal"] = "سجل العمليات",
